...
% The training data
%XTrain = [XTrain ones(1000,1)]  %1-2
XTrain = [XTrain ones(length(XTrain),1)]

% The test data
%XTest = [XTest ones(1000,1)]   %1-2
...
numIterations = 1000;  % Change this, number of iterations (epochs)-1
learningRate  = 0.009; % Change this, your learning rate-1

W0 = randn([size(XTrain,2) size(DTrain,2)])/10; % Change this, initialize your weight matrix 1-2
%W0 = randn([3 3])/10; % when dataset = 3
%W0 = randn([65 10]) %when dataset =4
...
%1:Test accuracy: 0.985
%2:Test accuracy: 0.854
